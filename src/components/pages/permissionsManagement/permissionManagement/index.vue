   ...
   <div style="width: 100%;height: 100%; ">
        <el-row :gutter="1">
            ...
            <el-col :span="18">
                ...
                <el-dialog title="添加权限" :visible.sync="dialogFormVisible" width="500px">
                    <el-form :model="form">
                        ...
                        <el-form-item label="权限编码" :label-width="formLabelWidth">
                            <el-input v-model="form.permission_encoding" autocomplete="off"></el-input>
                        </el-form-item>
                    </el-form>
            ...
            <el-col :span="4">
                <el-input
                        placeholder="权限名" icon="el-icon-search"
                        v-model="input"
                       ...
                       <template slot-scope="scope">
                           ...
                           <el-dialog title="编辑" :visible.sync="dialogFormVisibleEdit" width="700px">
                               <el-form :model="editForm">
                                           <el-form-item label="权限名" :label-width="formLabelWidth">
                                               <el-input v-model="editForm.permission_name" autocomplete="off"></el-input>
                                           </el-form-item>
                                           ...
                                           <el-form-item label="权限编码" :label-width="formLabelWidth">
                                               <el-input v-model="editForm.permission_encoding" autocomplete="off"></el-input>
                                           </el-form-item>
                               </el-form>
                               <div slot="footer" class="dialog-footer">
